      ...
      {isOpen && (
        <div style={{
          ...
          <div style={{ padding: '16px' }}>
            ...
            {/* Type filters */}
            <div style={{ display: 'flex', gap: '16px', marginTop: '12px', paddingBottom: '12px', borderBottom: '1px solid #e5e7eb' }}>
              {(['buurt', 'wijk', 'gemeente'] as const).map((type) => (
                <label key={type} style={{ display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer' }}>
                  ...
                  <span style={{ fontSize: '12px', color: '#9ca3af', backgroundColor: '#f3f4f6', padding: '2px 8px', borderRadius: '0' }}>
